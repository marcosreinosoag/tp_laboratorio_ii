...
namespace Tp3
{
    public partial class AltaUsuario : Form
    {
        ...
        private void AltaUsuario_Load(object sender, EventArgs e)
        {
            ...
            if (indexAModificar == -2)
            {
                this.cmb_cargo.SelectedIndex = 1;
        ...
        private void btn_aceptar_Click(object sender, EventArgs e)
        {
            ...
            if (ValidarDatos(id, clave, nombre, cmb_cargo.SelectedIndex, apellido, fechaDeNacimiento) == 6)
            {
                ...
                auxUsuario = new Usuario(id, clave, nombre, apellido, cargo, fechaDeNacimiento, new List<Instrumento>());
                if (auxUsuario != null)
                {
        ...
        private int ValidarDatos(string id, string clave, string nombre, int cargo, string apellido, DateTime fechaDeNacimiento)
        {
            ...
            if (this.indexAModificar == -1 || this.indexAModificar == -2)
            {
        ...
        {
            ToolTip toolTip1 = new ToolTip();
            toolTip1.SetToolTip(this.btn_errorCargo, "¡Seleccione un item!");
        }
